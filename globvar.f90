...
INTEGER, PARAMETER :: ncomm=3, nmonth=8, nloc=4, ncoupon=8, nmu=450, nxi=450, np=450,nhrs=3, nlpg=2, may=5, july=7, sept=9, dec=12
INTEGER :: nhh
...
REAL(8) :: ximat(ncomm,may:dec,nxi),ximat0(ncomm,may:dec,nxi),pmat0(ncomm,may:dec,np),pmat(ncomm,may:dec,np)
