...
REAL(8) :: alpha(ncomm),alphai(ncomm),ximean(ncomm),xi(ncomm),faultyweight,pf(ncomm),pm(ncomm),tf,tm,tb,te,mv(ncoupon),quota(ncomm,ncoupon),x(ncomm,nloc,ncoupon),util(nloc,ncoupon)
